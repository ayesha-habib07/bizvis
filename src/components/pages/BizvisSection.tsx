...
const BizvisSection = () => {
  ...
  return (
    <section
      className="py-16 px-4 md:px-[108px] lg:px-16"
      style={{
        background:
    ...
    >
      <div className="max-w-6xl mx-auto">
        {/* Heading */}
        <div className="mb-8 text-center pb-[59px]">
          <h2 className="text-2xl md:text-5xl font-bold text-[#D6D5D9]">
            What is <span className="text-[#029CF6]">Bizvis?</span>
          </h2>
          <p className="mt-2 text-[#D6D5D9] text-[20px] md:text-[24px]">
...
>
  {cards.map((card, i) => (
    ...
    >
      <div className="border-1 rounded-tl-[14px] rounded-tr-[14px] rounded-bl-[14px] rounded-br-[44px] flex md:flex-row flex-col justify-between text-white pt-[43px] px-[32px] pb-[46px] rounded-2xl shadow-md w-full gap-6 h-full bg-[#041227]">
        <div>
