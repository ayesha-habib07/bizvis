...
const SmarterDecision = () => {
  return (
    <div className="bg-[#020820] w-full lg:px-[114px] lg:pt-[128px] lg:pb-[109px] md:py-20 px-[24px] pt-[88px] pb-[36px]"  style={{
        background:
      ...
      <div className="flex flex-col  items-center max-w-7xl mx-auto gap-[25px]">
        {/* Text Section */}
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <p className="mt-4 text-[#D6D5D9] text-[18px] sm:text-lg">
